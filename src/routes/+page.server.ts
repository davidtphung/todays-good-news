	...
	const sampleStories: Record<string, { title: string; summary: string; source_url: string; source_name: string; location: { name: string; lat: number; lon: number } }[]> = {
		science: [
			...
			},
			{
				...
				source_url: 'https://www.quantamagazine.org/quantum-speedup-found-for-huge-class-of-hard-problems-20250317/',
		...
		health: [
			{
				...
				source_url: 'https://www.pfizer.com/news/press-release/press-release-detail/pfizer-initiates-phase-3-study-mrna-based-influenza-vaccine',
				source_name: 'Pfizer',
		...
		environment: [
			{
				...
				source_url: 'https://www.cnn.com/2022/08/04/australia/great-barrier-reef-high-coral-report-australia-climate-intl-hnk/index.html',
			...
			},
			{
				...
				source_url: 'https://en.wikipedia.org/wiki/Renewable_energy_in_Costa_Rica',
			...
			},
			{
				...
				source_url: 'https://theoceancleanup.com/press/press-releases/the-ocean-cleanup-breaks-10000000-kg-barrier/',
		...
		technology: [
			{
				...
				source_url: 'https://fortune.com/2024/04/08/open-source-ai-boom-openai-gpt-4/',
				source_name: 'Fortune',
			...
			},
			{
				...
				source_url: 'https://www.itu.int/itu-d/reports/statistics/2024/11/10/ff24-internet-use/',
				source_name: 'ITU',
				location: { name: 'Geneva, Switzerland', lat: 46.20, lon: 6.14 }
			}
		],
		community: [
			{
				...
				source_url: 'https://www.nbcnews.com/better/health/why-volunteering-habitat-humanity-so-meaningful-ncna814931',
			...
			},
			{
				...
				source_url: 'https://www.learntobe.org/intergenerational-tutoring',
				source_name: 'Learn To Be',
			...
			},
			{
				...
				source_url: 'https://modernfarmer.com/2024/09/philadephia-vacant-lots-urban-garden/',
				source_name: 'Modern Farmer',
		...
		education: [
			{
				...
				source_url: 'https://www.aljazeera.com/economy/2022/5/4/finlands-big-new-export-to-india-school-education',
			...
			},
			{
				...
				source_url: 'https://time.com/5916772/kid-of-the-year-2020/',
				source_name: 'TIME',
			...
			},
			{
				...
				source_url: 'https://ourworldindata.org/literacy',
				source_name: 'UNESCO',
		...
		arts: [
			{
				...
				source_url: 'https://fadmagazine.com/2024/09/17/street-art-revolution-how-murals-are-transforming-urban-landscapes/',
			...
			},
			{
				...
				source_url: 'https://www.howwegettonext.com/apps-are-helping-keep-indigenous-languages-alive-online/',
				source_name: 'How We Get To Next',
			...
			},
			{
				...
				source_url: 'https://www.npr.org/2011/03/15/134567922/the-road-to-an-american-el-sistema',
				source_name: 'NPR',
		...
		animals: [
			{
				...
				source_url: 'https://www.nationalgeographic.com/animals/article/pandas-vulnerable-endangered-species',
				source_name: 'National Geographic',
			...
			},
			{
				...
				source_url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC8907626/',
				source_name: 'NIH PMC',
			...
			},
			{
				...
				source_url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC10986847/',
				source_name: 'NIH PMC',
		...
		economy: [
			{
				...
				source_url: 'https://www.npr.org/2019/11/04/776163853/microsoft-japan-says-4-day-workweek-boosted-workers-productivity-by-40',
				source_name: 'NPR',
				location: { name: 'London, United Kingdom', lat: 51.51, lon: -0.13 }
			},
			{
				...
				source_url: 'https://www.worldbank.org/en/topic/poverty/overview',
			...
			},
			{
				...
				source_url: 'https://institute.coop/what-worker-cooperative',
				source_name: 'Institute for Cooperative Development',
		...
		space: [
			{
				...
				source_url: 'https://webbtelescope.org/contents/news-releases/2023/news-2023-120.html',
				source_name: 'Webb Space Telescope',
			...
			},
			{
				...
				source_url: 'https://www.nbcnews.com/science/space/live-blog/live-updates-spacex-starship-mega-rocket-launch-rcna155687',
				source_name: 'NBC News',
			...
			},
			{
				...
				source_url: 'https://blogs.esa.int/janwoerner/2016/11/23/moon-village/',
				source_name: 'ESA Blog',
		...
		sports: [
			{
				...
				source_url: 'https://www.npr.org/2024/08/09/nx-s1-5069315/olympic-refugee-team-medal-boxer-cindy-ngamba',
				source_name: 'NPR',
				location: { name: 'Paris, France', lat: 48.86, lon: 2.35 }
			},
			{
				...
				source_url: 'https://www.espn.com/olympics/story/_/id/41000000/paralympics-2024-paris',
				source_name: 'ESPN',
			...
			},
			{
				...
				source_url: 'https://www.eugenecivicalliance.org/preventing-juvenile-delinquency-through-sports/',
				source_name: 'Eugene Civic Alliance',
