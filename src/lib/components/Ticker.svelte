...
<div class="relative overflow-hidden border-b border-white/10 bg-surface-raised">
	<div class="flex items-center">
		<!-- Label -->
		<div
			class="relative z-10 flex-shrink-0 border-r border-white/10 bg-positive/10 px-spacing-12 py-spacing-8"
		>
		...
		<div class="relative flex-1 overflow-hidden">
			<div class="ticker-track flex items-center gap-spacing-24 whitespace-nowrap py-spacing-8 pl-spacing-16">
				{#each doubled as story, i (story.id + '-' + i)}
					<a
						href={story.source_url}
						target="_blank"
						rel="noopener noreferrer"
						class="inline-flex flex-shrink-0 items-center gap-spacing-8 transition-opacity duration-150 hover:opacity-70"
					>
