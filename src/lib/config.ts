...
export const PANELS: PanelConfig[] = [
	...
	{ id: 'globe', title: '3D Globe', icon: '', contentType: 'map', defaultWidth: 4, visible: true, order: 11 },
	{ id: 'trending', title: 'Trending Good News', icon: '', contentType: 'trending', defaultWidth: 2, visible: true, order: 12 },
	{ id: 'digest', title: "Today's Digest", icon: '', contentType: 'digest', defaultWidth: 2, visible: true, order: 13 },
